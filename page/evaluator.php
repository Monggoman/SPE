...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (isset($_POST["show"])) {
		...
		$query = "SELECT ass_name, f_sub, history.score, assessment.Total_q FROM assessment LEFT JOIN history ON history.f_ass_id = assessment.ass_id WHERE f_sub = '$subject' AND history.f_user_id = '$user_id' ";
